                        ...
                        <div class="form-group row">
                            <div class="col-md-10 mr-auto ml-auto">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="remember" id="rememberuser" {{ old('remember') ? 'checked' : '' }}>
                    ...
                    <form method="POST" action="{{ route('artist.login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-10 ml-auto mr-auto">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="remember" id="rememberArtist" {{ old('remember') ? 'checked' : '' }}>
